...
class Summary extends Resource
{
    ...
    const SUMMARY_WILL_RENEW                    = 'It will automatically renew on <wrap>{{{instance.date_subscription_end}}}</wrap> and charge your <wrap>{{{source.brand}}}</wrap> card ending <wrap>{{{source.last_four}}}</wrap> will be charged <wrap>{{{package.amount}}}</wrap>.';
