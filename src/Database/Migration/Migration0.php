...
namespace Nails\Subscription\Database\Migration;
    ...
    public function execute()
    {
        $this->query('
            CREATE TABLE `{{NAILS_DB_PREFIX}}subscription_instance` (
                ...
                `change_to_package_id` int(11) unsigned DEFAULT NULL,
                ...
                KEY `change_to_package_id` (`change_to_package_id`),
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}subscription_instance_ibfk_7` FOREIGN KEY (`change_to_package_id`) REFERENCES `{{NAILS_DB_PREFIX}}subscription_package` (`id`) ON DELETE SET NULL
